      ...
      <div className='container mx-auto align-element'>
        ...
        <div className='-mx-4 flex flex-wrap justify-center'>
          <TeamCard
            ...
            name='Emmanuel Mbankeu'
            profession='Co-Founder, Treasurer'
            facebookLink='/#'
            twitterLink='/#'
            instagramLink='/#'
          />
          <TeamCard
            ...
            name='Patrice Nzenang'
            profession='Co-Founder, List Manager'
            facebookLink='/#'
            twitterLink='/#'
            instagramLink='/#'
          />
          <TeamCard
            ...
            name='Jules Herve Noutcha'
            profession='Co-Founder, IT-Department'
            facebookLink='/#'
            twitterLink='/#'
            instagramLink='/#'
          />
      ...
      <div className='w-full px-4 sm:w-1/2 lg:w-1/3 xl:w-1/4 '>
        <div className='group mb-8 bg-base-100'>
          ...
          <div className='px-4 py-6 text-center'>
            ...
            <p className='text-sm text-base-content'>{profession}</p>
          </div>
        </div>
      </div>
    </>
