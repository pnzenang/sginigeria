      ...
      <div className='container mx-auto align-element'>
        <div className='-mx-4 flex flex-wrap justify-center'>
          <TeamCard
            ...
            name='Marthe Nana '
            profession='Marketing Expert, AIOF Delegate'
          />
          <TeamCard
            imageSrc='https://cdn.tailgrids.com/1.0/assets/images/team/image-07/image-02.png'
            name='Anna Maria'
            profession='Digital Marketer, AIOF Delegate'
          />
          <TeamCard
    ...
    <div className='w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4 '>
      <div className='group mb-8 rounded-[5px] px-5 pb-10 pt-12 shadow-xl bg-base-200 dark:shadow-box-dark '>
        ...
        <div className='text-center'>
          <h4 className='mb-1 text-lg font-bold text-base-content'>{name}</h4>
          <p className='mb-5 text-sm text-base-content'>{profession}</p>
        </div>
      </div>
    </div>
  );
